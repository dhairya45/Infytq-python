...
result=Instructor()
result.set_instructor_name("Kruti")
result.set_experience(4)
result.set_avg_feedback(4.6)
result.set_technology_skill(["python","java","c++"])
print(result.check_eligibility())
print(result.allocate_course("c#"))
